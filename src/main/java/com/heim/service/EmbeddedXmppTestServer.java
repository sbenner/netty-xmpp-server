...
//        try {
//            xmppServer = new XMPPServer("localhost");
//
...
//
//            Entity user = EntityImpl.parseUnchecked("camel_consumer@localhost");
//            accountManagement.addUser(user, "secret");
//
//            Entity user2 = EntityImpl.parseUnchecked("camel_producer@localhost");
//            accountManagement.addUser(user2, "secret");
//
//            Entity user3 = EntityImpl.parseUnchecked("camel_producer1@localhost");
...
//
//            InputStream stream = ObjectHelper.loadResourceAsStream("/home/sergey/KeyStore.jks");
...
//            conference.createRoom(EntityImpl.parseUnchecked("camel-anon@localhost"), "camel-anon", RoomType.FullyAnonymous);
//            conference.createRoom(EntityImpl.parseUnchecked("camel-test@localhost"), "camel-test", RoomType.Public);
...
//        keyStore.load(ObjectHelper.loadResourceAsStream("/home/sergey/KeyStore.jks"), "secret".toCharArray());
//
