...
public class Presence {
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "status", namespace = "jabber:client", type = Status.class, required = false),
            @XmlElementRef(name = "show", namespace = "jabber:client", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "priority", namespace = "jabber:client", type = JAXBElement.class, required = false)
    })
